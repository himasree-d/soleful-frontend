    ...
    <div className="min-h-[70vh] flex flex-col justify-center animate-in fade-in duration-500">
      <div className="max-w-md w-full mx-auto p-8 bg-white rounded-3xl shadow-sm border border-sage-light">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-heading font-medium text-ink mb-2">Create Account</h2>
          <p className="text-ink/60">Join Soleful to start shopping.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-ink/60">
          ...
          <Link to="/login" className="text-ink font-medium hover:underline decoration-sage underline-offset-4">
            Sign in
          </Link>
        </div>
      </div>
